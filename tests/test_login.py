...
def test_login(driver):
    ...
    try:
        ...
        raise AssertionError("Test refresh failed, refresh element is not available")
        # Wait for some time to observe the result
    print("RefreshDone")
    time.sleep(2)

    # result_nav = driver.find_element(By.XPATH, "[/html1]/body[1]/div[2]/aside[1]/section[1]/ul[1]/li[7]/a[1]")
    # result_nav.click()
